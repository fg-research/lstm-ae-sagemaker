...
## Model Description
### Model Architecture
The LSTM-AE model reconstructed the time series with a multivariate LSTM autoencoder.
The encoder and the decoder are stacked LSTM models with the same number of layers.
